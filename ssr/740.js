...
exports.ids = ['740'];
exports.modules = {
"726": (function (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
/* harmony default export */ const path_ = (path);
...
/* harmony default export */ function constant_(x) {
...
function link_link(curve) {
  ...
  function link() {
    ...
    if (!context) context = buffer = path_();
  ...
  link.x = function(_) {
    return arguments.length ? (x = typeof _ === "function" ? _ : constant_(+_), link) : x;
  };

  link.y = function(_) {
    return arguments.length ? (y = typeof _ === "function" ? _ : constant_(+_), link) : y;
  };
...
/* harmony default export */ function sankeyLinkHorizontal_() {
...
var sankeyDiagram_707fac0f_parser = function() {
...
sankeyDiagram_707fac0f_parser.parser = sankeyDiagram_707fac0f_parser;
const parser$1 = sankeyDiagram_707fac0f_parser;
let sankeyDiagram_707fac0f_links = [];
let sankeyDiagram_707fac0f_nodes = [];
let nodesMap = {};
const clear = () => {
  sankeyDiagram_707fac0f_links = [];
  sankeyDiagram_707fac0f_nodes = [];
  nodesMap = {};
...
const sankeyDiagram_707fac0f_addLink = (source, target, value) => {
  sankeyDiagram_707fac0f_links.push(new SankeyLink(source, target, value));
};
class SankeyNode {
  constructor(ID) {
    this.ID = ID;
...
const sankeyDiagram_707fac0f_findOrCreateNode = (ID) => {
  ID = mermaid_6dc72991_.e.sanitizeText(ID, (0,mermaid_6dc72991_.c)());
  if (!nodesMap[ID]) {
    nodesMap[ID] = new SankeyNode(ID);
    sankeyDiagram_707fac0f_nodes.push(nodesMap[ID]);
  }
  return nodesMap[ID];
};
const getNodes = () => sankeyDiagram_707fac0f_nodes;
const getLinks = () => sankeyDiagram_707fac0f_links;
const sankeyDiagram_707fac0f_getGraph = () => ({
  nodes: sankeyDiagram_707fac0f_nodes.map((node) => ({ id: node.ID })),
  links: sankeyDiagram_707fac0f_links.map((link) => ({
    source: link.source.ID,
    target: link.target.ID,
    value: link.value
  }))
});
const sankeyDiagram_707fac0f_db = {
  nodesMap,
  getConfig: () => (0,mermaid_6dc72991_.c)().sankey,
  getNodes,
  getLinks,
  getGraph: sankeyDiagram_707fac0f_getGraph,
  addLink: sankeyDiagram_707fac0f_addLink,
  findOrCreateNode: sankeyDiagram_707fac0f_findOrCreateNode,
...
const draw = function(text, id, _version, diagObj) {
  const { securityLevel, sankey: conf } = (0,mermaid_6dc72991_.c)();
  const defaultSankeyConfig = mermaid_6dc72991_.K.sankey;
  let sandboxElement;
  ...
  const svg = securityLevel === "sandbox" ? root.select(`[id="${id}"]`) : (0,src_/* select */.Ys)(`[id="${id}"]`);
  ...
  sankey$1(graph);
  const colorScheme = (0,src_/* scaleOrdinal */.PKp)(src_/* schemeTableau10 */.K2I);
...
${prefix}${Math.round(value * 100) / 100}${suffix}`;
  ...
  link.append("path").attr("d", sankeyLinkHorizontal_()).attr("stroke", coloring).attr("stroke-width", (d) => Math.max(1, d.width));
  (0,mermaid_6dc72991_.o)(void 0, svg, 0, useMaxWidth);
};
const renderer = {
  draw
};
